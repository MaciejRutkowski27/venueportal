...
const DesignerDropdownFilter = () => {
  ...
  useEffect(() => {
    ...
    const filtered = products.filter((product) =>
      product.designerName.toLowerCase().includes(searchInput.toLowerCase())
    );
    ...
    <>
      <div className="list-container">
        <div className="dropdown-container">
          <p className="subdescription">Designer</p>
...
export default DesignerDropdownFilter;
